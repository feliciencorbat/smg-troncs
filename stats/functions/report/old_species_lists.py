...
def old_species_lists(data: pd.DataFrame, year):
    ...
    old_species_maillettes = old_species_maillettes[["Espèce", "Auteur"]].drop_duplicates().sort_values('Espèce')
    old_species_bossy = old_species_bossy[["Espèce", "Auteur"]].drop_duplicates().sort_values('Espèce')
    old_species_isole = old_species_isole[["Espèce", "Auteur"]].drop_duplicates().sort_values('Espèce')
