...
def distribution_bar(data: pd.DataFrame, variable: str, show_plot: bool, export_files: bool, export_directory: str,
                     limit: int = 0) -> None:
    ...
    directory = None
    if export_files:
        directory = export_directory + "/distribution " + variable
